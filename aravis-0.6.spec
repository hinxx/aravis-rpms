...
Source0:	http://ftp.gnome.org/pub/gnome/sources/aravis/0.5/aravis-%{version}.tar.xz
...
%build
%configure --enable-usb --enable-packet-socket --disable-viewer --disable-gst-plugin --disable-gst-0.10-plugin
make %{?_smp_mflags}
